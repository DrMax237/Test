...
export default class Mat3 {
	...
	static fromEulerAngles(out: Mat3, eulerAngles: Vec3): Mat3 {
		...
		out.m[1] = -cy * sz;
		out.m[2] = sy;
		out.m[3] = cx * sz + cz * sx * sy;
		out.m[4] = cx * cz - sx * sy * sz;
		out.m[5] = -cy * sx;
		out.m[6] = sx * sz - cx * cz * sy;
		out.m[7] = cz * sx + cx * sy * sz;
		out.m[8] = cx * cy;
	 ...
	 */
	constructor(m00: number | FloatArray = 1, m01 = 0, m02 = 0, m03 = 0, m04 = 1, m05 = 0, m06 = 0, m07 = 0, m08 = 1) {
